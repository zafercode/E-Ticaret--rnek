...
import "./style.css";
import "../index.css";
import BlogResim from "../assets/blog.jpg";
    ...
    <div>
      <div className="bg-blog-img-mobil md:bg-blog-img h-80 w-full flex flex-row justify-around items-center bg-cover bg-center bg-no-repeat">
        <div className="flex flex-col p-8">
          <h1 className="text-white font-bold text-xl md:text-3xl mb-6">
          ...
          <div className="min-h-[50px] mt-8 xl:mt-0">
            ...
            <div className="bg-slate-100 min-h-min w-full mt-10 rounded-xl p-5">
              ...
              <input
                ...
                className="w-[100%] xl:w-[49%] focus:border-blue-500 outline-none border border-gray-300 border-solid p-2 rounded-md mr-2 mb-4"
              />
              <input
                type="text"
                placeholder="Ad - Soyad"
                className="w-[100%] xl:w-[49%] focus:border-blue-500 outline-none  border border-gray-300 border-solid p-2 rounded-md mb-4"
              />
              <input
                type="text"
                placeholder="E-Mail"
              ...
              <button className="bg-[#15284B] py-2 px-5 text-white rounded-lg">
                Gönder
              </button>
            </div>
            <div className="bg-slate-100 min-h-min w-full mt-10 rounded-xl p-5">
